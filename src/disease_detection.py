...
# Analyze image colors for disease detection
...
def predict_disease(image):
    ...
    # Rule-based detection from image colors
    scores = {}

    # Healthy: high green, balanced
    green_ratio = g / (r + g + b + 1)
    scores['Healthy'] = green_ratio * 100

    # Early Blight: brownish spots
...
def get_disease_advice_marathi(disease_name):
    advice = {
        'Healthy':             'तुमचे पीक निरोगी आहे! नियमित काळजी घ्या।',
        'Early Blight':        'तांबे-आधारित बुरशीनाशक फवारा। संक्रमित पाने काढा।',
        'Late Blight':         'मॅन्कोझेब किंवा मेटॅलॅक्सिल लगेच फवारा।',
        'Leaf Rust':           'प्रोपिकोनाझोल बुरशीनाशक वापरा।',
        'Powdery Mildew':      'सल्फर-आधारित बुरशीनाशक किंवा कडुलिंबाचे तेल फवारा।',
        'Bacterial Blight':    'कॉपर ऑक्सीक्लोराइड फवारा। ओल्या शेतात काम करू नका।',
        'Nutrient Deficiency': 'NPK खत द्या। माती परीक्षण करा।',
    }
    return advice.get(disease_name, 'कृषी तज्ञाचा सल्ला घ्या।')

def get_disease_advice_hindi(disease_name):
    advice = {
        'Healthy':             'आपकी फसल स्वस्थ है! नियमित देखभाल जारी रखें।',
        'Early Blight':        'तांबे आधारित फफूंदनाशक का छिड़काव करें।',
        'Late Blight':         'मैन्कोजेब या मेटालैक्सिल तुरंत लगाएं।',
        'Leaf Rust':           'प्रोपिकोनाजोल फफूंदनाशक का उपयोग करें।',
        'Powdery Mildew':      'सल्फर आधारित फफूंदनाशक या नीम तेल छिड़कें।',
        'Bacterial Blight':    'कॉपर ऑक्सीक्लोराइड का छिड़काव करें।',
        'Nutrient Deficiency': 'NPK उर्वरक दें। मिट्टी परीक्षण कराएं।',
    }
    return advice.get(disease_name, 'कृषि विशेषज्ञ से सलाह लें।')